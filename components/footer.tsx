        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-pixel text-[10px] tracking-widest text-foreground">
                Vibe<span style={{ color: "#F97316" }}>X</span>
              </span>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <Link href="/cracked/leaderboard" className="flex items-center min-h-11 font-pixel text-[10px] transition-colors duration-200 hover:text-[var(--neon-yellow)]" style={{ color: "var(--text)" }}>🧠 Cracked Score</Link>
