...
// 2026-05-14 — only import paths swapped from 'motion/react' → 'framer-motion'.
// Use case: "Claude is reviewing..." loading state on AIReviewPanel +
// stage-transition flourish in evolution-burst.
"use client";
