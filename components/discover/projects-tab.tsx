...
const CATEGORY_I18N: Record<string, string> = {
  "All": "cat.all",
  "AI Agent": "cat.aiAgent",
  "AI Tool": "cat.aiTool",
  "AI Game": "cat.aiGame",
  "AI Workflow": "cat.aiWorkflow",
  "AI Utility": "cat.aiUtility",
    ...
    <>
      ...
      >
        {categories.map((category) => (
          ...
          >
            {CATEGORY_I18N[category] ? t(CATEGORY_I18N[category] as Parameters<typeof t>[0]) : category}
          </button>
        ))}
      </motion.div>
                  ...
                  <div className="noise-bg relative overflow-hidden rounded-xl border border-white/[0.08] glass-card-strong transition-all duration-300 group-hover:border-white/15 group-hover:shadow-[0_8px_40px_-12px_rgba(139,92,246,0.2)]">
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="flex-1 p-6 md:p-8 flex flex-col justify-center">
                        ...
                        >
                          {CATEGORY_I18N[editorsPick.category] ? t(CATEGORY_I18N[editorsPick.category] as Parameters<typeof t>[0]) : editorsPick.category}
                        </Badge>
